...
/// <summary>
/// Represents client data for a connected player in a LAN server lobby.
/// Stores player identification and custom key-value data.
/// </summary>
internal sealed class LanServerClientData
{
    /// <summary>
    ...
    /// <summary>
    /// Custom key-value data associated with this client.
    /// </summary>
    internal Dictionary<string, string> Data = [];

    /// <summary>
    /// Serializes the client data to a packet writer.
    /// </summary>
    ...
    /// <summary>
    /// Deserializes client data from a packet reader.
    /// </summary>
