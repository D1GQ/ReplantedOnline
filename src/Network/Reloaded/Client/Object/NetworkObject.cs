...
namespace ReplantedOnline.Network.Reloaded.Client.Object;
...
internal abstract class NetworkObject : RuntimePrefab, INetworkIdentifier, INetworkSerializable
{
    ...
    /// </summary>
    [HideFromIl2Cpp]
    public SyncedDirtyBits SyncedBits { get; set; } = new SyncedDirtyBits();
    ...
    /// </summary>
    internal sealed class SyncedDirtyBits
    {
        /// <summary>
        /// Gets or sets the current state of dirty bits as a bitmask.
        /// </summary>
        internal uint DirtyBits { get; set; }
