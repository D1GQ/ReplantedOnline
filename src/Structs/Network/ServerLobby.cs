...
internal struct ServerLobby
{
    ...
    internal ServerLobby(Lobby lobby)
    {
        ...
        ModVersion = lobby.GetData(ReplantedOnlineMod.Constants.Network.MOD_VERSION_KEY);
        GameCode = lobby.GetData(ReplantedOnlineMod.Constants.Network.GAME_CODE_KEY);
        Name = string.Empty;
    }
